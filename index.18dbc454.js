...
const close_modal = document.querySelector(".button_close");
const modal = document.querySelector(".burger_menu_max");
...
const check = document.querySelector(".checkbox_button");
form.addEventListener("submit", (e)=>{
    e.preventDefault();
});
const modal_button_two = document.querySelector(".burger_sign");
const modal_buttonnn = document.querySelector(".button_sign_nav");
const close_modalll = document.querySelector(".button_close_sign");
const modall = document.querySelector(".sign_form");
modal_button_two.addEventListener("click", openMModal);
modal_buttonnn.addEventListener("click", openMModal);
close_modalll.addEventListener("click", closeMModal);
...
const form_main = document.querySelector(".sign_form form");
...
},{}]},["jQVXF","1SICI"], "1SICI", "parcelRequirec64c")
